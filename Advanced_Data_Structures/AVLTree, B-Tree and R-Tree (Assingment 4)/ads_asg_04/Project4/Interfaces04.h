...
struct IRTree { 
  IRTree() {}
  virtual ~IRTree() {}
  virtual void hilbertSort(std::vector<IPoint *>& points) = 0;
  virtual void bulkInsert(std::vector<IPoint *>& points) = 0;
  virtual std::vector<IPoint *> findWithin(IPoint * top_left, IPoint * bottom_right) = 0;
};
